    ...
    <>
        ...
        <div className="flex flex-col lg:flex-row gap-3 pb-5 ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-7 mt-12 lg:mt-0">
            <div className="flex flex-col ps-2">
              ...
              <Link
                href="#"
                className="mb-2 text-gray-600 text-[17px] font-[400] hover:text-[var(--prim-color)] hover:scale-105 transition-transform transition-colors duration-300"
              >
                Become a Vendor
              </Link>
              <Link
          ...
          <div className="flex flex-col">
            ...
            <div className="flex">
              ...
              <Image src={StoreImg2} alt="StoreImg1" />
            </div>
            <div className="socail-media flex gap-3 mt-5">
      ...
      <div className="bottom-footer px-[8%] lg:px-[12%] py-5 bg-[var(--prim-light)]">
        <div className="flex flex-col md:flex-row justify-between items-center gap-5">
            <p className="text-lg">©2025. All Rights Reserved By <a href="#" className="font-semibold">dolphicode</a></p>
