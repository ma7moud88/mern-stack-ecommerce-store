        ...
        <div className="grid gap-4 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7">
            ...
            {deliveryOption === "ship" && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                <select className="form-select border border-gray-300 rounded appearance-none px-2 py-2 md:cols-span-2">
                  <option>Egypt</option>
                ...
                <input
                  ...
                  placeholder="First Name (optoinal)"
                />
                <input
                  type="text"
                  className="border border-gray-300 rounded w-full p-2"
          ...
          <div className="lg:col-span-5">
            <div className=" border border-gray-300 p-4 rounded shadow">
              ...
              <button
                className="w-full mt-3 mb-3 py-2 bg-green-600 cursor-pointer text-white rounded hover:bg-green-800 transition-all"
                onClick={handlePlaceOrder}
              >
                Place Order
              </button>
