                ...
                <div className="blog-content mt-3">
                  ...
                  <div className="flex mt-5 gap-5">
                    <p className="text-gray-500">
                      <i className="bi bi-calendar2-week text-[var(--prim-light)] pr-1"></i>
                      {blog.date}
                    </p>
                    <p className="text-gray-500">
                      <i className="bi bi-chat-text text-[var(--prim-light)] pr-1"></i>
                      {blog.date}
                    </p>
                  </div>
                </div>
              ...
              <div className="p-5">
                {blogData.map((blog) => (
                  <div
                    ...
                    onClick={() => setSelectedBlog(blogData.indexOf(blog))}
                  >
                    <div className="w-1/2">
